...
- Retired routes (all patch debt removed): 0
- Routes with live patch debt: 10

## Blocking Routes

- /events: visual/functional/seo checks are incomplete; 7-day stability window has not elapsed; decommission checklist is incomplete; route-specific patch debt remains (monitoring-checks-pending)
- /in-the-news: visual/functional/seo checks are incomplete; 7-day stability window has not elapsed; decommission checklist is incomplete; route-specific patch debt remains (monitoring-checks-pending)
- /center-city: visual/functional/seo checks are incomplete; 7-day stability window has not elapsed; decommission checklist is incomplete; route-specific patch debt remains (monitoring-checks-pending)
