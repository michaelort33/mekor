...
| /team-4 | W3 | on (TEAM0_NATIVE_TEAM_4, implemented) | v:pending / f:pending / seo:pending | not-started | 0/0/10 | runtime:no, doc:no, css:no | monitoring-checks-pending | visual/functional/seo checks are incomplete; 7-day stability window has not elapsed; decommission checklist is incomplete; route-specific patch debt remains |
| /from-the-rabbi-s-desk | W3 | on (TEAM0_NATIVE_FROM_THE_RABBI_S_DESK, implemented) | v:pending / f:pending / seo:pending | not-started | 0/0/1 | runtime:no, doc:no, css:no | monitoring-checks-pending | visual/functional/seo checks are incomplete; 7-day stability window has not elapsed; decommission checklist is incomplete; route-specific patch debt remains |
| /donations | W4 | on (NATIVE_APP_ROUTE_DONATIONS, implemented) | v:pending / f:pending / seo:pending | not-started | 0/1/3 | runtime:no, doc:no, css:no | monitoring-checks-pending | visual/functional/seo checks are incomplete; 7-day stability window has not elapsed; decommission checklist is incomplete; route-specific patch debt remains |
| /kosher-map | W4 | on (TEAM0_NATIVE_KOSHER_MAP, implemented) | v:pending / f:pending / seo:pending | not-started | 1/0/4 | runtime:no, doc:no, css:no | monitoring-checks-pending | visual/functional/seo checks are incomplete; 7-day stability window has not elapsed; decommission checklist is incomplete; route-specific patch debt remains |
