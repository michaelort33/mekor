...
export const newsletterTemplates = pgTable("newsletter_templates", {
  ...
  activeBlobPathname: varchar("active_blob_pathname", { length: 512 }),
  activeBlobUrl: text("active_blob_url"),
  activeBlobVersionId: varchar("active_blob_version_id", { length: 255 }),
