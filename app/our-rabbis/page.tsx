          ...
          <article className={styles.profileLayout}>
            ...
            <div className={styles.profileBody}>
              ...
              <div className={styles.profileText}>
                ...
                <p>Rabbi Hirsch serves as the Director and local halachic advisor for the expansive <InlineLink href="https://www.centercityeruv.com/">Center City Eruv</InlineLink> and is the rabbinic administrator of IKC Kosher Certification in Center City, which has facilitated the substantial growth of <InlineLink href="/center-city">kosher establishments in this area</InlineLink>.</p>
